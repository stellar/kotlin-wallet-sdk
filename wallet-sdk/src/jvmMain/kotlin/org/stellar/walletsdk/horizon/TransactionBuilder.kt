...
internal constructor(
   ...
   */
  actual fun lockAccountMasterKey(sponsorAddress: String?) =
   ...
   * @throws [HorizonRequestFailedException] for Horizon exceptions
   */
  actual fun addAccountSigner(signerAddress: String, signerWeight: Int, sponsorAddress: String?) =
    building(sponsorAddress) {
      log.debug {
  ...
  actual fun setThreshold(low: Int, medium: Int, high: Int, sponsorAddress: String?) =
    building(sponsorAddress) {
      SetOptionsOperation.Builder()
        .setLowThreshold(low)
...
internal actual val defaultTrustLimit =
