...
import org.stellar.walletsdk.horizon.toEnvelopeXdrBase64
import org.stellar.walletsdk.passphrase
...
constructor(
  ...
  suspend fun challenge(
    ...
    if (jsonResponse.networkPassphrase != cfg.stellar.network.passphrase) {
  ...
  private suspend fun sign(
    ...
    var challengeTxn = challengeResponse.toTransaction()

    if (challengeTxn.hasClientDomain()) {
